						...
						<div class="row">
							...
							<div class="col-md-6">
			                	<div>
									...
									<label class='col-sm-4' style="padding-top:7px;">작업대상</label>
						...
						<div class="row">
		                	<div class="col-md-6">
		                		<div>
									<label class='col-sm-4' style="padding-top:7px;">작업명<i class="text-danger">*</i></label>
									<div class='col-sm-8'>
										<input id='SR_WORK_TITLE' type='text' class='form-control required' disabled>
									</div>
								</div>
							</div>
							<div class="col-md-6">
...
<script>
	...
	$.fncGrid1 = function() {
		...
		$.ritusGrid({
			...
			url: '${pageContext.request.contextPath}/data/work/srListByAsset.rts',
			postData: {
...
$(function() {
	...
	$('#btnRegist').click(function() {
		...
		$('#detailModal #PATH').html($.g_selectedPath);
	...
	$('#detailModal2 .btnAdd').click(function() {
