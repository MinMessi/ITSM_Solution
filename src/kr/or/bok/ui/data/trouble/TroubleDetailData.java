 ...
 * @version 1.0 
 * @created 2018. 1. 16. 오후 1:48:11
 */

@Component("data.trouble.troubledetail")
public class TroubleDetailData implements IData {
	...
	public String invoke(Map<String, String> parameters, HttpServletRequest request, HttpServletResponse response,
		...
		Map<String, Object> map = dataManager.getData("TRB00001", data_id);
