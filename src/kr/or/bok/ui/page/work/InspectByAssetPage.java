 ...
 */
@Component("page.work.inspectbyasset")
public class InspectByAssetPage implements IPage {
	...
	public ModelAndView invoke(Map<String, String> parameters, HttpServletRequest request, HttpServletResponse response,
		...
		result.addObject("CDE00013", dataManager.getCodeTreeDataOptions("CDE00013", null, false, true));
		result.addObject("CDE00014", dataManager.getCodeTreeDataOptions("CDE00014", null, false, true));
		result.addObject("CDE00015", dataManager.getCodeTreeDataOptions("CDE00015", null, false, true));
		result.addObject("CDE00016", dataManager.getCodeTreeDataOptions("CDE00016", null, false, true));
		
		//breadcrumb 설정 - 페이지 path를 적어준다.
		String breadcrumb = "/작업관리/기술지원 현황";
